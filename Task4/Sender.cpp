...
int main(int argc, char* argv[])
{
    ...
    HANDLE hEventStarted = OpenEvent(EVENT_MODIFY_STATE, FALSE, wideEventName.c_str());
    ...
    HANDLE hNotesAmountSemaphore = OpenSemaphore(SEMAPHORE_ALL_ACCESS, FALSE, L"MyNotesAmountSemaphore");
    if (hNotesAmountSemaphore == NULL)
    {
        return GetLastError();
    }
    HANDLE hNotNotesAmountSemaphore = OpenSemaphore(SEMAPHORE_ALL_ACCESS, FALSE, L"MyNotNotesAmountSemaphore");
